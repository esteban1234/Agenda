<?php
    ...
    $this->CellFitSpace(190,7, utf8_decode("Catalogo de Zonas"),0,1,'C');
    $this->Ln(5);
    ...
    function cabeceraHorizontal($cabecera)
    {
        ...
        foreach($array as $fila)
        {
            ...
            $this->CellFitSpace(184,7, utf8_decode($fila[1]),'LR', 0 , 'C');
    ...
    function datosHorizontal()
    {
        ...
        if($id == '1')
        {
            $consulta = $db->query("SELECT * FROM catazon;");
        }
        else
        {
            $consulta = $db->query("SELECT * FROM catazon ORDER BY DES_ZON ASC;");
        }
        ...
        foreach($consulta as $fila)
        {
            ...
            $this->CellFitSpace(13,7, utf8_decode($fila['NUM_ZON']),0, 0 , 'C' );

            $this->CellFitSpace(184,7, utf8_decode($fila['DES_ZON']),'LR', 0 , 'L' );
...
// $consulta = $db->query("SELECT * FROM catacli WHERE NUM_ZON = '$id';");
    ...
    $pdf->AddPage();
    $miCabecera = array('Código', 'Descripción');
